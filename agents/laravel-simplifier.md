...
> **Source:** [`laravel/agent-skills` — `laravel-simplifier`](https://github.com/laravel/agent-skills/blob/main/laravel/agents/laravel-simplifier.md). Apache-2.0, © Laravel LLC. Conteúdo importado verbatim — quaisquer modificações futuras devem preservar a atribuição.
